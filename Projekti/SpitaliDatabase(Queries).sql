...
Create table Pacienti(
 ...
 create table PacientiKompaniaSigurimit (
     Pacienti_ID int REFERENCES Pacienti(Pacienti_ID),
     ID int REFERENCES KompaniaSigurimit(ID)
 )
...
Create Table CaktohetDHoma (
    Pacienti_ID int REFERENCES Pacienti(Pacienti_ID) ON DELETE CASCADE ON UPDATE CASCADE,
    Nr_Dhomes int REFERENCES Dhoma(Nr_Dhomes) ON DELETE CASCADE ON UPDATE CASCADE,
...
Insert into Kualifikimi_Doktorit values(1333,'Diploma')
Insert into Kualifikimi_Doktorit values(1341,'Diploma')
Insert into Kualifikimi_Doktorit values(1342,'Diploma')

Insert into Kualifikimi_Doktorit values(1344,'Degree')
Insert into Kualifikimi_Doktorit values(1345,'Degree')

Insert into Kualifikimi_Doktorit values(1348,'Diploma')
Insert into Kualifikimi_Doktorit values(1340,'Diploma')
...
Insert into Specializimi_Infermierit values(1359,'Stomatolog')
...
Insert into regjistron values(25,1354)
 ...
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('PRISIG','Prishtine','B4')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('SIGURIA','Prishtine','B5')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('KOSOVA E RE','Prishtine','B6')
  Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('SIGAL','Prishtine','B7')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('BRAND','Prishtine','B8')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('KINDLE','Prishtine','B9')
  Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('SIGURIM','Prishtine','B10')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('SIGURIM(Mitrovice)','Mitrovice','B11')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('UNIQUE','Prishtine','B12')
 Insert into KompaniaSigurimit(Emri, Qyteti, Rruga) values('COMPSIG.','Prishtine','B13')

Insert into PacientiKompaniaSigurimit values(1, 1000 )
Insert into PacientiKompaniaSigurimit values(2, 1000 )
Insert into PacientiKompaniaSigurimit values(3, 1000 )

Insert into PacientiKompaniaSigurimit values(4, 1001 )
Insert into PacientiKompaniaSigurimit values(5, 1001 )
Insert into PacientiKompaniaSigurimit values(6, 1001 )

Insert into PacientiKompaniaSigurimit values(7, 1002 )
Insert into PacientiKompaniaSigurimit values(8, 1002 )
Insert into PacientiKompaniaSigurimit values(9, 1003 )

Insert into PacientiKompaniaSigurimit values(10, 1003 )
Insert into PacientiKompaniaSigurimit values(12, 1004 )
Insert into PacientiKompaniaSigurimit values(13, 1004 )

Insert into PacientiKompaniaSigurimit values(14, 1005 )
Insert into PacientiKompaniaSigurimit values(25, 1005 )
Insert into PacientiKompaniaSigurimit values(15, 1006 )
...
Insert into Trajtimi(Pacienti_ID, Emri_Trajtimit) values (15,'Infektim')
Insert into Trajtimi(Pacienti_ID, Emri_Trajtimit) values (16,'Infektim')
Insert into Trajtimi(Pacienti_ID, Emri_Trajtimit) values (17,'Medical')
Insert into Trajtimi(Pacienti_ID, Emri_Trajtimit) values (18,'Surgical')
Insert into Trajtimi(Pacienti_ID, Emri_Trajtimit) values (19,'Medical')
...
Insert into KontaktiEmergjent values(105,16,'Blend','Gashi')
Insert into KontaktiEmergjent values(106,15,'Blenda','Baftiu')
Insert into KontaktiEmergjent values(107,17,'Albatrit','Zeneli')
Insert into KontaktiEmergjent values(108,18,'Endrit','Gashi')
...
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Trajtim',2,1359)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Fizio',2,1360)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Analiz',2,1361)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Fotografi',1,1362)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Pediatri',2,1363)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Operacion',3,1364)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Emergjenc',2,1365)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Staf',2,1366)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Laborator',0,1367)
Insert into Dhoma(Tipi_Dhomes, Kati, Infermieri_ID) values ('Pritjes',0,1368)

Insert into CaktohetDHoma values(10, 2002)
Insert into CaktohetDHoma values(11, 2003)
Insert into CaktohetDHoma values(12, 2004)
Insert into CaktohetDHoma values(13, 2005)
Insert into CaktohetDHoma values(14, 2006)
Insert into CaktohetDHoma values(15, 2007)
Insert into CaktohetDHoma values(15, 2008)
Insert into CaktohetDHoma values(16, 2002)
Insert into CaktohetDHoma values(12, 2003)
Insert into CaktohetDHoma values(11, 2004)
Insert into CaktohetDHoma values(19, 2005)
Insert into CaktohetDHoma values(20, 2006)
Insert into CaktohetDHoma values(25, 2007)
Insert into CaktohetDHoma values(25, 2008)
Insert into CaktohetDHoma values(12, 2009)
Insert into CaktohetDHoma values(10, 2000)
Insert into CaktohetDHoma values(14, 2002)
Insert into CaktohetDHoma values(13, 2004)
Insert into CaktohetDHoma values(21, 2005)
Insert into CaktohetDHoma values(22, 2007)
Insert into CaktohetDHoma values(21, 2002)
...
-- Queries
--------------------------------------------
--1 Të krijoni min. 8 query të thjeshta (4 për student), të realizohen vetëm me një relacion (tabelë)
--Endrit
-- Selektoni ID e pacientit, Emrin dhe Mbiemrin per ata paciente qe jetojne ne rrugen 'A1'
Select p.Pacienti_ID,p.Emri, p.Mbiemri from Pacienti p
Where Rruga like 'A1'
--

-- Selektoni Numrin e Doktoreve qe asistohen nga Infermieret 
select count (distinct I.Doktori_ID) as 'Nr i Doktoreve'
from Infermieri I
--

-- Selektoni Id e pacientit dhe shumen mesatare per cdo fature te pacienteve ne spital
select f.Pacienti_ID, avg(f.Shuma) as 'AVG' from Fatura f
group by f.Pacienti_ID
--

--Selektoni pacientet qe kane lindur nga datat '1990-01-01' dhe '1992-01-01'
...
--------------------------------------------
--2 Të krijoni min. 8 query të thjeshta (4 për student), të realizohen në minimum dy relacione (tabela) e më tepër.
--Endrit
--Selektoni emrin,mbiemrin e recepsionistit si dhe id e pacientit, emrin dhe mbiemrin e pacientit duke e shikuar se cili
-- recepsionist regjistron pacientet e ne spital
...
--Selektoni ID e Pacientit dhe Nr e kontakteve emrgjente qe nje pacient ka
...
--Selektoni Id e Pacientit emrin dhe mbiemrin, sa fatura ka pasur gjithsej dhe shumen mesatare te faturave
-- per cdo pacient qe ka me shume se 1 fature
...
-- Selektonii te dhenat mjeksore per Rrahman Llapjani
...
Where p.Mbiemri = 'Dushi' or p.Mbiemri = 'Hysejni' and p.Pacienti_ID = ne.Pacienti_ID
...
Where Specializimi In('Ortolog','Pediater','Farmacist') and p.Pacienti_ID = t.Pacienti_ID and t.Doktori_ID =d.Doktori_ID
...
--------------------------------------------
--3 Të krijoni min. 8 query të avancuara (4 për student), të realizuara në minimum dy relacione (tabela) e më tepër.
--Endrit

--Selektoni emrin dhe mbiemrin e pacienteve qe hala nuk kane ndonje fature ne Spital
select p.Emri, p.Mbiemri from Pacienti p
left join Fatura f on p.Pacienti_ID = f.Pacienti_ID
where f.Pacienti_ID is Null


--Selektoni Id, Ilaqi, Diagnozen, Emrin dhe Mbiemrin e Pacienteve qe kane me shume se 1 trajtim ne spital
With PacientetETrajtuar AS
(Select t.Pacienti_ID, count(*) [Nr Trajtimeve] from Trajtimi t
Group By t.Pacienti_ID
having count(*) > 1
)
select tdm.Pacienti_ID, tdm.Ilaqi, tdm.Diagnoza, p.Emri, p.Mbiemri, [Nr Trajtimeve] from TeDhenatMjeksore tdm
inner join Pacienti p on p.Pacienti_ID = tdm.Pacienti_ID
inner join PacientetETrajtuar pet on tdm.Pacienti_ID = pet.Pacienti_ID
--

--Selektoni Emrin, Mbiemrin, Infermierin, Doktorin e Pacientit qe jane trajtuar tek Infermeret me specializim Stomatolog
CREATE VIEW PacientetTrajtuarStomatolog as 
(Select p.Pacienti_ID from  Pacienti p 
inner join Trajtohet t on p.Pacienti_ID = t.Pacienti_ID 
inner join Infermieri i on i.Infermieri_ID = t.Infermieri_ID 
inner join Specializimi_Infermierit si on si.Infermieri_ID = t.Infermieri_ID and si.Specializimi = 'Stomatolog' )

select p.Emri, p.Mbiemri, i.Infermieri_ID, d.Doktori_ID from Pacienti p
inner join Trajtohet t on p.Pacienti_ID = t.Pacienti_ID
inner join Infermieri i on i.Infermieri_ID = t.Infermieri_ID
inner join PacientetTrajtuarStomatolog pts on p.Pacienti_ID = pts.Pacienti_ID
inner join Doktori d on d.Doktori_ID = t.Doktori_ID
order by 1
--

--Selektoji emrin, mbiemrin, Dianozen Pacientet te cilet jane caktuar ne dhoma qe kane per te bere vetem Analiza
create view PacientetPerAnalize AS 
(Select p.Pacienti_ID from Pacienti p
inner join CaktohetDHoma cd on cd.Pacienti_ID = p.Pacienti_ID
inner join Dhoma d on d.Nr_Dhomes = cd.Nr_Dhomes and d.Tipi_Dhomes = 'Analiz'
)

select distinct p.Emri, p.Mbiemri, tdm.Diagnoza from Pacienti p
inner join TeDhenatMjeksore tdm on tdm.Pacienti_ID = p.Pacienti_ID
inner join PacientetPerAnalize ppa on ppa.Pacienti_ID = p.Pacienti_ID
...
--
--------------------------------------------
--4 Të krijoni min. 8 subquery të thjeshta (4 për student).
--Endrit
--Selektoni informata per doktoret qe kane kualifikim Degree
select * from Doktori d
where d.Doktori_ID in (
     select kd.Doktori_ID from Kualifikimi_Doktorit kd where kd.Kualifikimi = 'Degree' )
--

--Selektoni emrin, mbiemrin, Ilaqin dhe shumen e faturave per cdo paciente qe kane shume te faturave me te madhe se mesatarja e te gjitha shumave 
select p.Emri, p.Mbiemri, tdm.Ilaqi, sum(f.Shuma) [Shuma] from Pacienti p 
inner join TeDhenatMjeksore tdm on p.Pacienti_ID = tdm.Pacienti_ID
inner join Fatura f on f.Pacienti_ID = tdm.Pacienti_ID
where f.Shuma > (Select avg(f.Shuma) from Fatura f)
group by p.Emri, p.Mbiemri, tdm.Ilaqi
--

--Selekto Id, Emrin, Mbiemrin e Doktorit te cilet hala nuk kane trajtuar ndonje Pacient
Select d.Doktori_ID, d.Emri, d.Mbiemri from Doktori d
left JOIN Trajtohet t on d.Doktori_ID = t.Doktori_ID
left join Pacienti p on p.Pacienti_ID = t.Pacienti_ID
where d.Doktori_ID not in (select t.Doktori_ID from Trajtohet t)
--

--Selekto Emrin dhe Sasine e Kompanive te sigurimit qe kane me shume se 2 numra te telefonit
Select ks.Emri, (select count(nks.Nr_Telefonit) from NrTelefonitKompaniaSigurimit nks 
where nks.Emri = ks.Emri) [Sasia]
from KompaniaSigurimit ks
group by ks.Emri
having (select count(nks.Nr_Telefonit) from NrTelefonitKompaniaSigurimit nks 
where nks.Emri = ks.Emri) > 2
order by ks.Emri
...
--------------------------------------------
--5 Të krijoni min. 8 subquery të avancuara (4 për student). (min. 1 subquery në klauzolën
-- SELECT, dhe min. 1 subquery ne klauzolën FROM)
--Endrit
--Selektoni id, emrin, Sasine e numrave te telefonit me shume se 2 te kompanive te sigurimit si dhe sa paciente  ne spital kane cdo kompani
Select ks.ID, ks.Emri,sub.[Nr E Telefonit], Pacientet = (Select count(pks.Pacienti_ID) from PacientiKompaniaSigurimit pks
Where pks.ID = ks.ID) 
from KompaniaSigurimit ks, (Select nks.Emri, count(*) [Nr E Telefonit] from NrTelefonitKompaniaSigurimit nks
group by nks.Emri) sub 
Where sub.Emri = ks.Emri and sub.[Nr E Telefonit] > 2
--

--Selektoni nr e dhomes dhe tipin e dhomes si dhe  id , emrin, e Infermierit  qe drejton dhomen dhe Pacientet per ate dhome, dhe per infermierit qe
-- kane lindur mes viteve '1999-01-01' and '2001-01-01'
Select d.Nr_Dhomes, Infermieri.Infermieri_ID,Infermieri.Emri,d.Tipi_Dhomes,Pacientet = (Select count(*)
from CaktohetDHoma ck where d.Nr_Dhomes = ck.Nr_Dhomes ) from Dhoma d 
inner join (select i.Infermieri_ID, i.Emri, i.Mbiemri FROM Infermieri i where i.Data_Lindjes
between '1999-01-01' and '2001-01-01') as InfermIeri on d.Infermieri_ID = InfermIeri.Infermieri_ID
--


--Selektoni Te gjitha specializimet e doktoreve qe jane me pak se te gjitha specializimet e infermiereve 
Select s.Specializimi,count(*)[Nr Doktoreve] from Doktori d, Specializimi_Doktorit s
where d.Doktori_ID = s.Doktori_ID
group by s.Specializimi
having count(*) < ALL (
    Select count(*) from Specializimi_Infermierit si, Infermieri i
    where si.Infermieri_ID = i.Infermieri_ID
    group by si.Specializimi
)
--

--Selektoni punonjesit qe i'u fillon emri me b dhe kane id me te madhe se 1300
SELECT sub.*
FROM ( 
    SELECT *
    FROM Punonjesi p
...
--------------------------------------------
--6 Të krijoni min. 8 query/subquery (4 për student). Duke përdorur operacionet e algjebrës
--relacionale (Union, Prerja, diferenca, etj.)
--Endrit

-- Selektoni Pacientet qe jane per kontroll dhe jo kirurgjikale
create view [Pacientet per Kontroll jo Surgical ] as
(
select p.Pacienti_ID 
from Pacienti p, Trajtimi t
where p.Pacienti_ID = t.Pacienti_ID and t.Emri_Trajtimit = 'Kontroll'
except
select p.Pacienti_ID
from Pacienti p, Trajtimi t
where p.Pacienti_ID = t.Pacienti_ID and t.Emri_Trajtimit like 'Surgical'
)

select p.Pacienti_ID, p.Emri, p.Mbiemri
from  [Pacientet per Kontroll jo Surgical ] kontroll, Pacienti p
where kontroll.Pacienti_ID = p.Pacienti_ID
--

--Selektoni id, emrin dhe mbiemrin e Doktoreve qe kane degree dhe diploma
create View [Doktoret me Degree dhe Diploma ] as 
(
    select d.Doktori_ID
    from Doktori d, Kualifikimi_Doktorit kd
    where d.Doktori_ID = kd.Doktori_ID and kd.Kualifikimi = 'Degree'
    INTERSECT
    select d.Doktori_ID
    from Doktori d, Kualifikimi_Doktorit kd
    where d.Doktori_ID = kd.Doktori_ID and kd.Kualifikimi = 'Diploma'
)
select d.Doktori_ID, d.Emri, d.Mbiemri
from  [Doktoret me Degree dhe Diploma ] degdip, Doktori d
where degdip.Doktori_ID = d.Doktori_ID


--Selekto id, emrin dhe mbiemrin e Infermiereve  qe menaxhojne dhomen ne katin e 2 dhe Infermieret tjere qe  menxahojne dhomat ne katin 1
Select i.Infermieri_ID, i.Emri, i.Mbiemri from Infermieri i 
inner join Dhoma d on i.Infermieri_ID = d.Infermieri_ID
where d.Kati = 2
UNION
Select i.Infermieri_ID, i.Emri, i.Mbiemri from Infermieri i 
inner join Dhoma d on i.Infermieri_ID = d.Infermieri_ID
...
--Selekto id, emrin dhe mbiemrin e pacienteve qe jane trajtuar te doktori Dorant dhe pacientet qe jane trajtuar tek doktori Lek
select p.Pacienti_ID, p.Emri, p.Mbiemri from Pacienti p 
inner join Trajtohet t on t.Pacienti_ID = p.Pacienti_ID 
where t.Doktori_ID in (Select d.Doktori_ID from Doktori d where d.Emri = 'Dorant')
UNION
select p.Pacienti_ID, p.Emri, p.Mbiemri from Pacienti p 
inner join Trajtohet t on t.Pacienti_ID = p.Pacienti_ID 
where t.Doktori_ID  in (Select d.Doktori_ID from Doktori d where d.Emri = 'Lek')
...
--------------------------------------------
--7 Të krijoni min. 8 Proceduara të ruajtura (Stored Procedure) (4 për student)

--Endrit
--Printoje mesazhin per pacientet qe kane vetem nje trajtim, me shume se nje ose asnje trajtim
 create proc TrajtimiPacienteve
 @Input_ID int
 as
 Begin
 declare @trajtimi int;

 select @trajtimi= (select count(*) [Nr Trajtimit]
 from Trajtimi t inner join Pacienti p on p.Pacienti_ID = t.Pacienti_ID
 where p.Pacienti_ID = @Input_ID)

  IF @trajtimi = 1
  begin Print 'Pacienti ka vetem nje Trajtim!'
  end 
  ELSE
  begin
  if @trajtimi > 1
  Print 'Pacienti ka me shume se nje Trajtim!'
  else 
  Print 'Pacienti nuk eshte trajtuar!'
  end
  end

TrajtimiPacienteve 15
-- 


--Printoje perqindjen per Emrin e trajtimin qe i'u dergohet ne input
create procedure TipiTrajtimitPerqindja
@Input VARCHAR(255)
AS
declare @Pacientet int = (Select count(*) from Pacienti);
declare @Trajtimi int = ((Select count(*) from Trajtimi t where t.Emri_Trajtimit = @Input)*100)/@Pacientet
Print(concat('Perqindja eshte: ', @Trajtimi, '%' ))


TipiTrajtimitPerqindja 'Infektim'
--

--Printo sa pacient ka ne dhoma per cdo kat
create procedure KthePacientet
AS
Declare @Kati int = 0;
Declare @Count int;
...
While @Kati < 4 
BEGIN
    set @Count = (Select count(*) from Pacienti p
    inner join CaktohetDHoma cd on  p.Pacienti_ID= cd.Pacienti_ID
    inner join Dhoma d on d.Nr_Dhomes = cd.Nr_Dhomes and d.Kati = @Kati);

    set @temp = convert(varchar(255),@Kati);
    set @temp1 = convert(varchar(255),@count);
   PRINT (concat('Ne dhomat ne katin ', @temp, ' jane ', @temp1,' Paciente'));
   SET @Kati = @Kati + 1
END
...
--Printo perqindjet se sa paciente kane trajtim kirurgjikal dhe sa pacient kane mbetur per tu trajtuar 
 create proc PerqindjetEPacienteve
 as
 Begin
 declare @Pacientet int = (select count(*) from Pacienti)
 declare @PacientetSurgical int = (select count(*) [Trajtimi]
 from Pacienti p inner join Trajtimi t  on p.Pacienti_ID = t.Pacienti_ID and t.Emri_Trajtimit = 'Surgical')

 print 'Perqinja e Pacienteve qe kane Trajtim Kururgjikal eshte: ' +Cast((100* @PacientetSurgical/@Pacientet) as varchar(255)) + '%'
 
 declare @JoteTrajtuar int = (select count(*)
from Trajtimi t  right join Pacienti p on t.Pacienti_ID= p.Pacienti_ID 
where t.Pacienti_ID is null)

 print 'Perqindja e Pacienteve qe ende nuk jane trajtuar (Duke pritur) ' +Cast((100* @JoteTrajtuar/@Pacientet) as varchar(255)) + '%'
 
 End
 PerqindjetEPacienteve
